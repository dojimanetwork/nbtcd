...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/dojimanetwork/nbtcd/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/dojimanetwork/nbtcd/mining/cpuminer
```
