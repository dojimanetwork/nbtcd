...
* Install the MSI available at: [btcd windows installer](https://github.com/dojimanetwork/nbtcd/releases)
...
```bash
git clone https://github.com/dojimanetwork/nbtcd $GOPATH/src/github.com/dojimanetwork/nbtcd
...
* [Using bootstrap.dat](https://github.com/dojimanetwork/nbtcd/blob/master/docs/configuration.md#using-bootstrapdat)
