...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/dojimanetwork/nbtcd/peer)
...
```bash
$ go get -u github.com/dojimanetwork/nbtcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/dojimanetwork/nbtcd/peer#example-package--NewOutboundPeer)  
