...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/dojimanetwork/nbtcd/btcutil/coinset)
...
```bash
$ go get -u github.com/dojimanetwork/nbtcd/btcutil/coinset
```
